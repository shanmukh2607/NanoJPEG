...
testbench_mod.vvp: testbench_mod.v axi4_mem_periph.v picorv32.v rowidct_synth.v col_idct_synth.v /usr/share/yosys/xilinx/cells_sim.v
	$(IVERILOG) -o $@ $(subst C,-DCOMPRESSED_ISA,$(COMPRESSED_ISA)) $^
	chmod -x $@
...
testbench_verilator: testbench_mod.v picorv32.v axi4_mem_periph.v testbench.cc rowidct_synth.v col_idct_synth.v /usr/share/yosys/xilinx/cells_sim.v
